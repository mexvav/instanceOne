...
class IntegerEntityFieldTest extends AbstractSpringContextTest {

    private SpringContextUtils utils;

    @Autowired
    IntegerEntityFieldTest(SpringContextUtils utils) {
        this.utils = utils;
    }
    ...
    void testEntityField() {
        ...
        entityClass.addFields(EntityFieldFactory.integerEntityField());
