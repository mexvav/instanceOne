...
class BooleanEntityFieldTest extends AbstractSpringContextTest {

    private SpringContextUtils utils;

    @Autowired
    BooleanEntityFieldTest(SpringContextUtils utils) {
        this.utils = utils;
    }
    ...
    void testEntityField() {
        ...
        entityClass.addFields(EntityFieldFactory.booleanEntityField());
